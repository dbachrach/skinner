...
define(['text', 'lib/Handlebars'], function (text, Handlebars) {
    'use strict';

    var buildMap = {},
        buildTemplateSource = "define('{pluginName}!{moduleName}', ['lib/Handlebars'], function (Handlebars) { return Handlebars.template({content}); });\n";
